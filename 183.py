...
def find_customers_my(customers: pd.DataFrame, orders: pd.DataFrame) -> pd.DataFrame:
...
def find_customers_other(customers: pd.DataFrame, orders: pd.DataFrame) -> pd.DataFrame:
